...
<head>
  ...
  <meta charset="utf-8">
  <meta name="keywords" content="Contact Us, ​Get in touch, Benefits of Coaching for Individuals.">
...
<body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="fr">
          ...
          <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
            <div class="u-inner-container-layout u-sidenav-overflow">
              ...
              <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="Contact.html">Se connecter</a>
                </li>
  ...
  <section class="u-align-center u-clearfix u-grey-5 u-section-1" id="carousel_9b4a">
    <div class="u-clearfix u-sheet u-sheet-1">
      <div class="custom-expanded u-align-center u-container-style u-group u-shape-rectangle u-white u-group-1">
        <div class="u-container-layout u-container-layout-1">
          <h2 class="u-text u-text-default u-text-1">S'inscrire</h2>
          <div class="u-align-left u-social-icons u-spacing-25 u-social-icons-1">
            <a class="u-social-url" target="_blank" href=""><span
                class="u-icon u-icon-circle u-social-facebook u-social-icon u-icon-1"><svg class="u-svg-link"
                  ...
                  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-2c27"></use>
                </svg><svg x="0px" y="0px" viewBox="0 0 112 112" id="svg-2c27" class="u-svg-content">
            ...
            <a class="u-social-url" target="_blank" href=""><span
                class="u-icon u-icon-circle u-social-icon u-social-twitter u-icon-2"><svg class="u-svg-link"
                  preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
                  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-b70a"></use>
                </svg><svg x="0px" y="0px" viewBox="0 0 112 112" id="svg-b70a" class="u-svg-content">
            ...
            <a class="u-social-url" target="_blank" href=""><span
                ...
                </svg><svg x="0px" y="0px" viewBox="0 0 112 112" id="svg-6b6b" class="u-svg-content">
            ...
            <a class="u-social-url" target="_blank" href=""><span
                class="u-icon u-icon-circle u-social-icon u-social-linkedin u-icon-4"><svg class="u-svg-link"
                  preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
                  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-b853"></use>
                </svg><svg x="0px" y="0px" viewBox="0 0 112 112" id="svg-b853" class="u-svg-content">
            ...
            <a class="u-social-url" target="_blank" href=""><span
                class="u-icon u-icon-circle u-social-google u-social-icon u-icon-5"><svg class="u-svg-link"
                  preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
                  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-eb42"></use>
                </svg><svg x="0px" y="0px" viewBox="0 0 112 112" id="svg-eb42" class="u-svg-content">
          ...
          <div class="u-form u-form-1">
            <form action="../adduser.php" method="post" source="email" name="form" style="padding: 0px;">
              <div class="u-form-group u-form-name u-form-group-1">
                <label for="name" class="u-label">Nom </label>
                <input type="text" placeholder="Nom de votre compte" id="name" name="name"
              ...
              <div class="u-form-group u-form-group-3">
                <label for="text-af00" class="u-label">Mot de passe</label>
                <input type="text" placeholder="mot de passe " id="text-af00" name="text-af00"
                  class="u-border-none u-grey-5 u-input u-input-rectangle">
                <span id="password-error"></span>
              </div>
              <div class="u-form-group u-form-group-4">
                <label for="text-7bd6" class="u-label">CIN</label>
                <input type="text" placeholder="Votre numero CIN " id="text-7bd6" name="text-7bd6"
                  class="u-border-none u-grey-5 u-input u-input-rectangle">
                <span id="number-error"></span>

              </div>
              <div class="u-form-group u-form-phone u-form-group-5">
                <label for="phone" class="u-label">Numéro de téléphone</label>
                <input type="tel" id="phone" name="phone" class="u-border-none u-grey-5 u-input u-input-rectangle">
                <span id="phone-error"></span>
              </div>
              <div class="u-form-group u-form-select u-form-group-6">
                <label for="select-ef80" class="u-label">Sexe</label>
                <div class="u-form-select-wrapper">
                  <select id="select-ef80" name="select" class="u-border-none u-grey-5 u-input u-input-rectangle">
                    <option value="H" data-calc="H">Homme</option>
                    <option value="F" data-calc="F">Femme</option>
                  </select>
              ...
              <div class="u-form-group u-form-select u-form-group-7">
                <label for="select-9b1e" class="u-label">S'inscrire en tant que </label>
                <div class="u-form-select-wrapper">
                  <select id="select-9b1e" name="select-1" class="u-border-none u-grey-5 u-input u-input-rectangle">
                    <option value="T" data-calc="T">taxite</option>
                    <option value="B" data-calc="B">Beneficiaire</option>
                    <!--<option value="A" data-calc="A">admin</option> -->
                  </select>
                  <svg class="u-caret u-caret-svg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px"
                    viewBox="0 0 16 16" style="fill:currentColor;" xml:space="preserve">
              ...
              <ul></ul>
              <div class="u-form-group u-form-phone u-form-group-5">
                <label for="captcha_input" class="u-label"> Captcha</label>
                <input type="text" id="captcha_input" name="captcha_input" placeholder="Reecrire le Code Captcha"
                ...
                <label for="captcha" class="u-label"> Captcha Code </label>
                <div class="captcha">
                  <?php echo $captcha; ?>
                </div>
              </div>
              ...
              <div class="u-align-center u-form-group u-form-submit u-form-group-8">
                <button
                  class="u-border-none u-btn u-btn-submit u-button-style u-palette-3-base u-btn-1">Confirmer</button>
  ...
  <script src="controle_saisie_inscription.js" defer></script>
</body>
